...
def parse_args():
    ...
    parser.add_argument(
        "--gamma_1", default=5, type=int, required=False,
        help="The first self-stepping threshold",
    )
    parser.add_argument(
        "--gamma_2", default=18, type=int, required=False,
        help="The second self-stepping threshold",
    )
    parser.add_argument(
        "--lambda_1", default=0.8, type=float, required=False,
        help="Balancing factor",
    )
    parser.add_argument(
        "--lambda_2", default=0.9, type=float, required=False,
        help="Balancing factor",
    )
    parser.add_argument(
        "--sigma", default=0.6, type=float, required=False,
        help="Base margin",
    )
    parser.add_argument(
        "--alpha_1", default=0.9, type=float, required=True,
    )
    parser.add_argument(
        "--alpha_2", default=0.1, type=float, required=True,
    )
    parser.add_argument(
        "--w_simcse", default=1.0, type=float,
    )
    parser.add_argument(
    ...
    parser.add_argument("--logit-scale", type=float, default=0.07,
                        help="initialization of InfoNCE learnable temperature")
    ...
    parser.add_argument("--C", type=float, default=3.16,
                        help="inverse regularizer for logistic reg (sklearn implementation).")
    parser.add_argument(
        "--linear-prob-mode",
    ...
    parser.add_argument(
        "--seed", type=int, default=3, help="Fix random seed."
    )
