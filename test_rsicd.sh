...
do
    ...
    torchrun --nproc_per_node 1 -m training.test \
        --retrieval-data1 '/xiaolin/xyq/MyMethod/RRSITR/precomp/rsicd/rsicd_test.csv' \
        ...
        --loss 'InfoNCE' \
        --resume "/xiaolin/xyq/MyMethod/RRSITR/training/logs/RSICD/NC00/seed${SEED}/checkpoints/best_model.pt" \
        --logs "/xiaolin/xyq/MyMethod/RRSITR/training/logs/RSICD/NC00/seed${SEED}/checkpoints" \
