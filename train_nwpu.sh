...
do
    ...
    do
        ...
        torchrun --nproc_per_node 1 -m  training.main \
            --train-data "/xiaolin/xyq/MyMethod/RRSITR/precomp/nwpu/NWPU-NC-${NC}.csv" \
            --retrieval-data1 '/xiaolin/xyq/MyMethod/RRSITR/precomp/nwpu/nwpu_val.csv' \
            ...
            --logs "/xiaolin/xyq/MyMethod/RRSITR/training/logs/NWPU/NC${NC}"  \
            --name "seed${SEED}"
